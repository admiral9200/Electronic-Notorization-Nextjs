        ...
        <div className={`sm:px-20 py-5 ${isOpenPay ? 'flex justify-between space-x-5' : ''}`}>
            <div className={`${isOpenPay ? 'w-[70%]' : ''}`}>
                ...
                <div className='flex space-x-4 mt-5'>
                    ...
                    <button className='border border-gray-100 bg-gray-700 text-gray-100 text-base font-semibold rounded-md py-2 px-6 hover:border-gray-700 hover:bg-gray-100 hover:text-gray-700 transition-all'>Reject & Re-generate</button>
                </div>
            </div>
