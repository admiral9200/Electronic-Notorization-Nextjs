// import { PDFPageProxy, getDocument } from "pdfjs-dist/types/src/display/api"
...
//     const pdf = await getDocument({ url: uri }).promise
...
// const renderPageToImage = async (page: PDFPageProxy, scale: number = 3): Promise<string> => {
